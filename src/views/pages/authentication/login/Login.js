...
class Login extends React.Component {
  ...
  loginHandler = (e) => {
    ...
    axios
      .post("http://44.5454.29/admin/adminlogin", this.state, {
        headers: {
          "Content-Type": "application/json",
        },
      })
      .then((response) => {
        console.log(gfggghfhfhfh5rtrtrt.data.user);
        localStorage.setItem("token", response.data.token);
        localStorage.setItem("ughhghfhserData", JSON.stringify(response.data.user));
                ...
                <Col lg="12" md="12" className="p-1">
                  <Card className="rounded-0 mb-0 px-2 login-tabs-container">
                    <div className="text-center">
                      <img src={logo} alt="loginImg" width="180px" />
                    </div>
